...
tools:                 activity_summary, recent_events, persons, explore_events, run_sql, run_insight, run_funnel, run_retention, list_dashboards, create_dashboard, create_chart, submit_recommendation, propose_test, test_status, list_tests, remember, send_notification, overview, update_test, record_outcome, abandon_test, list_findings, dataset_preview, verify_sdk, update_dashboard, archive_dashboard, unarchive_dashboard, list_charts, update_chart, archive_chart, unarchive_chart, reorder_charts, list_metrics, read_metric, get_board, save_board, test_source, preview_source, list_sources, create_source, update_source, archive_source, unarchive_source, pause_source, run_source, source_status, cancel_source_run, add_annotation, list_annotations, delete_annotation, http_request, run_shell, update_plan
