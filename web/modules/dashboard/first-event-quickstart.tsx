...
export function FirstEventQuickstart() {
  ...
  function agentTask(): string {
    return [
      ...
      '',
      'Web: install the browser SDK per sdk/browser/README.md (npm scope is',
      '  not yet published — use the release tarball or the <script> bundle), then:',
      ...
      'iOS / server: use the matching SDK (sdk/ has platform equivalents) — same',
      '  init/identify/reset contract, platform field set by the SDK.',
      '',
